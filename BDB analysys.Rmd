...
model_set_def = data.frame(gameId = integer(), playId = integer(),
                       def1_dist = integer(), def1_s = integer(),
                       def1_a = integer(), def1_zone = integer(),def2_dist = integer(), 
                       def2_s = integer(), def2_a = integer(), def2_zone = integer(),
                       def3_dist = integer(), def3_s = integer(),
                       def3_a = integer(), def3_zone = integer(), def4_dist = integer(),
                       def4_s = integer(), def4_a = integer(), def4_zone = integer(),
                       def5_dist = integer(), def5_s = integer(),
                       def5_a = integer(), def5_zone = integer(),  def6_dist = integer(),
                       def6_s = integer(), def6_a = integer(), def6_zone = integer(),
                       def7_dist = integer(), def7_s = integer(),
                       def7_a = integer(), def7_zone = integer(),  def8_dist = integer(), 
                       def8_s = integer(), def8_a = integer(), def8_zone = integer(),
                       def9_dist = integer(), def9_s = integer(),
                       def9_a = integer(), def9_zone = integer(), def10_dist = integer(), 
                       def10_s = integer(), def10_a = integer(), def10_zone = integer(),
                       def11_dist = integer(), def11_s = integer(),
                       def11_a = integer(), def11_zone = integer()
                       )
...
for (games in unique(received$gameId)) {
  ...
  for (plays in unique(x$playId)) {
    ...
    #Prints out all of the values into one data frame
    model_set_def[nrow(model_set_def)+1,] <- c(games, plays, min1, s1, a1, zone1,
                                       min2, s2, a2, zone2,
                                       min3, s3, a3, zone3,
                                       min4, s4, a4, zone4,
                                       min5, s5, a5, zone5,
                                       ...
                                       min8, s8, a8, zone8,
                                       min9, s9, a9, zone9,
                                       min10, s10, a10, zone10,
                                       min11, s11, a11, zone11)
