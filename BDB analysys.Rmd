...
received_model_vars = received %>% select("gameId", "playId",  "playDirection", "returnDirectionIntended", "returnDirectionActual", "quarter", "yardlineTotal", "preSnapHomeScore", "preSnapVisitorScore","kickLength", "kickReturnYardage", "receiveTeamHome")
#, "playResult"
...
final_set =  merge(model_set, received_model_vars[!duplicated(received_model_vars), ], by = c("gameId", "playId"))
