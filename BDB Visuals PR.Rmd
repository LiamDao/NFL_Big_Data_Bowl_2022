...
coverteam1 <- coverteam1 %>%
  left_join(teams_colors_logos$team_logo_espn, by = c('possessionTeam' = 'team_abbr'))
coverteam1 <- coverteam1 %>%
  select(possessionTeam, team_logo_espn, n, yards_given_up, yards_expected_diff, yards_expected)
...
reactable(
  coverteam1,
  columns = list(
    possessionTeam = colDef(name = "Team"),
    n = colDef(name = "Returns"),
